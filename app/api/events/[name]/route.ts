...
// NOTE ABOUT PARAMS SHAPE
// -------------------------------------------------------------
// You referenced a StackOverflow pattern like:
//   export async function GET(req, { params }: { params: Promise<{ name: string }> }) { ... }
// That promise-based params shape currently applies to PAGE / LAYOUT server components
// in certain experimental Next.js versions. Route handlers (app/api/*) still receive a
// synchronous context object: (req, { params }). If we force the Promise type here,
// Next's type validator rejects the export signature.
//
// For reference ONLY (do not uncomment in current stable):
//
// export async function GET(req: NextRequest, { params }: { params: Promise<{ name: string }> }) {
//   const { name } = await params; // experimental pattern
//   // ...rest logic
// }
// -------------------------------------------------------------

// GET /api/events/[name] -> public event data with totals
// export async function GET(_req: NextRequest, context: { params: { name: string } }) {
//   try {
//     // The 'context' object is a simple object, not a promise.
//     // We can access 'params' directly from it.
...
// EXPERIMENTAL: promise-based params style you requested
...
// export async function PATCH(req: NextRequest, context: { params: { name: string } }) {
//   try {
//     // The 'context' object is a simple object, not a promise.
//     // We can access 'params' directly from it.
//     const { name } = context.params;
